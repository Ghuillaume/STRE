...
//Initialisation du context : 
	- Creation d'un tableau de taches périodiques par ordre de prio : tabPrioPeriodique
	- Creation d'un tableau de tâches apériodiques par ordre de prio : tabPrioAperiodique
	- Création d'un tableau qui contient la capacité restante de chaque tache : tabTpsRestant
init_context()
...
tant que (t < getHyperPeriode())
    ...
    si(need_to_poll)
        ...
        Pour taches dans tabPrioPeriodique
        	...
        	Fin Si 
        Fin Pour
        // si Aucune tache n'a été choisie -> temps creux
        Si tache_elue == false
        	//temps_creux
        Fin Si
    fsi
