...
\chapter{Introduction}
	...
	Le résultat final sera observable sous deux formes : un affichage à l'écran, et un fichier .ktr en sortie écrit selon la syntaxe acceptée par l'outil Kiwi, qui nous permettra de visualiser graphiquement l'ordonnancement des tâches.
			...
			\begin{figure}
				\centering
				\includegraphics[scale=0.7]{intro_diag.png}
				\caption{Résumé}
			\end{figure}
			\FloatBarrier
	...
	\section{Spécification du logiciel}
		...
		\subsection{Fonctionnalité}
			...
			\subsubsection{Simulation d'ordonnancement}
				Ceci permet, à partir du jeu de tâches contenue dans le fichier d'entrée, de simuler un ordonnancement selon un algorithme spécifique. Deux fonctions sont disponible : 
				\begin{itemize}
					\item Simulation selon RM
					\item Simulation selon EDF
				\end{itemize}
				Ce choix est naturel dans la mesure où les algorithmes apériodiques s'appuient sur ceux des tâches périodiques.			
...
Finsi
			...
			\subsubsection{Rate Monotonic + Serveur}
				...
				\paragraph{Post-condition : les tâches ont été ordonnancé} 
