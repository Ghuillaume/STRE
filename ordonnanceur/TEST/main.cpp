...
int main(int argc, char** argv) {
	...
	TachePeriodique* tacheP1 = new TachePeriodique(2,6,6);
	TachePeriodique* tacheP2 = new TachePeriodique(2,8,8);
	TachePeriodique* tacheP3 = new TachePeriodique(2,12,12);
